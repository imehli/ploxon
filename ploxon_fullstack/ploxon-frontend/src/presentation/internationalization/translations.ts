    ...
    translations: {
      ...
      ploxonDescription: {
        ...
        cleanArchitecture: {
          ...
          div4: `Dans le monde du développement, nous pourrions réduire le travail d'un développeur au fait d'élaborer les liens appropriés entre 
    ...
    translations: {
      ...
      ploxonDescription: {
        ...
        cleanArchitecture: {
          ...
          div4: `In the world of development, we could reduce a developer's job to elaborating the appropriate links between different systems, 
